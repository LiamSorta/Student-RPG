...
public class Answer4 : MonoBehaviour {
	...
	void Q1(){
		if(Stats.QuestionNumber==1 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true) 
		{
	...
	void Q2(){
		if(Stats.QuestionNumber==2 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q3(){
		if(Stats.QuestionNumber==3 && Input.GetKeyUp(KeyCode.E)&& Answer4State == true)
		{
	...
	void Q4(){
		if(Stats.QuestionNumber==4 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q5(){
		if(Stats.QuestionNumber==5 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q6(){
		if(Stats.QuestionNumber==6 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q7(){
		if(Stats.QuestionNumber==7 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q8(){
		if(Stats.QuestionNumber==8 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
	...
	void Q9(){
		if(Stats.QuestionNumber==9 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
			Stats.smartArse = Stats.smartArse+1;
	...
	void Q10(){
		if(Stats.QuestionNumber==10 && Input.GetKeyUp (KeyCode.E)&& Answer4State == true)
		{
			Stats.correct = Stats.correct+1;
